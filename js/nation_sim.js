...
(function (root, factory) {
  ...
  const DEFAULTS = {
    GER: { leader: '阿道夫·希特勒(垂死)', capital: '柏林', ideology: '纳粹主义',
      ...
      nuclear: { warheads: 580, delivery: { icbm: 60, slbm: 16, bomber: 220 }, deterrence: 78 },
    ...
    USA: { leader: '约翰·肯尼迪', capital: '华盛顿', ideology: '民主主义',
      ...
      nuclear: { warheads: 420, delivery: { icbm: 90, slbm: 40, bomber: 180 }, deterrence: 72 },
    ...
    JAP: { leader: '昭和天皇', capital: '东京', ideology: '军国主义',
      ...
      nuclear: { warheads: 320, delivery: { icbm: 40, slbm: 24, bomber: 120 }, deterrence: 68 },
      population: 430000000, industry: { civilSlots: 420, militarySlots: 280, hiTechSlots: 60, energySlots: 100, efficiency: 0.72 },
      tech: { militaryTier: 2, civilTier: 2, nuclearTier: 1, rocketTier: 1 },
    ...
    BUR: { leader: '希姆莱', capital: '南锡', ideology: '极端纳粹主义',
      ...
      nuclear: { warheads: 36, delivery: { icbm: 8, slbm: 0, bomber: 24 }, deterrence: 45 },
